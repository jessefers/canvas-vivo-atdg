---
codigo: DINF-00
titulo: "Visão geral — Div. de Informática"
versao: "0.2.0"
status: rascunho
setor_codigo: S03.03-DINF
setor: "Div. de Informática"
atualizado_em: "2026-09-03T01:58:25Z"
agente: pop-dinf-00
versao_diretrizes: "1.8"
---

# POP DINF-00 — Visão geral — Div. de Informática
...
|---|---|---|
| Secretaria Administrativa | Div. de Informática | Divisão de Informática da Secretaria Administrativa. Playbook em construção. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Tecnologia da Informação | Visão geral do setor (playbook) | suporte | S03.03-DINF |
...
|---|---|
| Código | DINF-00 |
| Setor | Div. de Informática (`S03.03-DINF`) |
...
graph TD
  ...
  P["DINF-00<br/>Visão geral — Div. de Informática"]
  S03_03_DINF --> P
  classDef setor fill:#EEF0F7,stroke:#1B2747,stroke-width:1.5px,color:#1B2747
  classDef destaque fill:#FDEAEE,stroke:#CC1544,stroke-width:3px,color:#1B2747
  classDef vizinho fill:#E0F2F8,stroke:#0B4D66,stroke-width:1.5px,color:#0B4D66
  class S01_DG,S03_SADM,S03_03_DINF setor
  class P destaque
```
...
- Se o setor não tiver processos definidos, priorizar o mapeamento das atividades de maior volume ou risco (suporte técnico e infraestrutura de TI)
...
```mermaid
flowchart LR
  subgraph R1["Div. de Informática"]
    direction LR
    e1(("A definir"))
...
**Raias:** Div. de Informática

| Id | Tipo | Elemento | Raia |
|---|---|---|---|
| e1 | inicio | A definir | Div. de Informática |
| e2 | atividade | Levantar as atividades e rotinas da área junto à chefia e aos servidores | Div. de Informática |
| e3 | atividade | Mapear os fluxos e os responsáveis por etapa | Div. de Informática |
| e4 | atividade | Identificar as normas aplicáveis e os pontos de atenção | Div. de Informática |
| e5 | fim | Concluído | Div. de Informática |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DINF/DINF-00.pop.json` (diretrizes v1.8)._
