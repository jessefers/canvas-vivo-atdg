...
|---|---|---|
| Secretaria Administrativa | Div. de Compras | Fluxo da contratação por dispensa emergencial com contrato. O interessado elabora termo de referência, cotações e tabela comparativa e envia ao Planejamento, que analisa e submete à autorização da Direção Geral. Compras faz pesquisa de preços e checa regularidade fiscal; o Jurídico emite parecer; o Financeiro empenha; a Licitação elabora o contrato, que é assinado, publicado no DIOE e tem portarias de gestor/fiscal emitidas pela Direção Geral. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Contratações Públicas | Fluxo — Dispensa Emergencial (com Contrato) | core | S03.10-DCOM |
...
|---|---|---|---|---|---|---|
| 1 | Interessado elabora termo de referência, cotações e tabela comparativa | A definir | — | — | A definir | — |
...
| 4 | Jurídico emite parecer; Financeiro faz o empenho no GMS | A definir | — | — | A definir | — |
| 5 | Licitação elabora o contrato; assina-se e publica-se no DIOE | A definir | — | — | A definir | — |
| 6 | Direção Geral emite portarias de Gestor e Fiscal | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Compras"]
    direction LR
    e1(("A definir"))
    e2["Interessado elabora termo de referência, cotações e tabela comparativa"]
    ...
    e5["Jurídico emite parecer; Financeiro faz o empenho no GMS"]
    e6["Licitação elabora o contrato; assina-se e publica-se no DIOE"]
    e7["Direção Geral emite portarias de Gestor e Fiscal"]
    e8((("Concluído")))
  end
  e1 --> e2
  e2 --> e3
...
| e2 | atividade | Interessado elabora termo de referência, cotações e tabela comparativa | Div. de Compras |
...
| e5 | atividade | Jurídico emite parecer; Financeiro faz o empenho no GMS | Div. de Compras |
| e6 | atividade | Licitação elabora o contrato; assina-se e publica-se no DIOE | Div. de Compras |
| e7 | atividade | Direção Geral emite portarias de Gestor e Fiscal | Div. de Compras |
