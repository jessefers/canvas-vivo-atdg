...
|---|---|---|
| Secretaria Administrativa | Div. de Compras | Fluxo da contratação por inexigibilidade com ordem de compra. O interessado elabora termo de referência, cotações e carta de exclusividade e envia ao Planejamento, que submete à Direção Geral. Compras pesquisa preços e checa regularidade fiscal; o Jurídico emite parecer; o Financeiro faz a DDF; a Licitação publica o aviso, aguarda 3 dias e publica a inexigibilidade, retornando o processo a Compras para a Ordem de Compra. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Contratações Públicas | Fluxo — Inexigibilidade (com Ordem de Compra) | core | S03.10-DCOM |
...
|---|---|---|---|---|---|---|
| 1 | Interessado elabora termo de referência, cotações e carta de exclusividade | A definir | — | — | A definir | — |
...
| 5 | Licitação publica aviso, aguarda 3 dias e publica a inexigibilidade | A definir | — | — | A definir | — |
| 6 | Compras emite a Ordem de Compra | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Compras"]
    direction LR
    e1(("A definir"))
    e2["Interessado elabora termo de referência, cotações e carta de exclusiv…"]
    ...
    e6["Licitação publica aviso, aguarda 3 dias e publica a inexigibilidade"]
    e7["Compras emite a Ordem de Compra"]
    e8((("Concluído")))
  end
  e1 --> e2
  e2 --> e3
...
| e2 | atividade | Interessado elabora termo de referência, cotações e carta de exclusividade | Div. de Compras |
...
| e6 | atividade | Licitação publica aviso, aguarda 3 dias e publica a inexigibilidade | Div. de Compras |
| e7 | atividade | Compras emite a Ordem de Compra | Div. de Compras |
