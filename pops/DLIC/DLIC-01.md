...
|---|---|---|
| Secretaria Administrativa | Div. de Licitação | Fluxo do contrato de aquisição decorrente de licitação. A CPL/Licitação gera o contrato, verifica regularidade fiscal, lança no GMS e, após assinado, publica no DIOE, encaminhando à Direção Geral. Esta emite e publica as portarias de Gestor e Fiscal; o Planejamento registra o contrato e inclui portarias no GMS; o Gestor solicita o empenho ao Financeiro e a aquisição dos itens, e o Fiscal acompanha a entrega e as notas fiscais. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Contratações Públicas | Fluxo — Contrato de Aquisição (Licitação) | core | S03.06-DLIC |
...
| 5 | Gestor solicita empenho e aquisição; Fiscal acompanha entrega/NF | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Licitação"]
    ...
    e6["Gestor solicita empenho e aquisição; Fiscal acompanha entrega/NF"]
    e7((("Concluído")))
  end
  e1 --> e2
  e2 --> e3
...
| e6 | atividade | Gestor solicita empenho e aquisição; Fiscal acompanha entrega/NF | Div. de Licitação |
