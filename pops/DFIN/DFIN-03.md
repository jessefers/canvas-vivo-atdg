...
| Normativa | Procedimentos de despesas — PRAF/Unioeste |
| Produto ATDG | POP |
...
| 2 | Identificar a etapa aplicável ao tipo de despesa | A definir | — | — | A definir | — |
| 3 | Seguir a tramitação local até empenho/pagamento | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Finanças"]
    ...
    e3["Identificar a etapa aplicável ao tipo de despesa"]
    e4["Seguir a tramitação local até empenho/pagamento"]
    e5((("Concluído")))
  end
  e1 --> e2
  e2 --> e3
...
| e3 | atividade | Identificar a etapa aplicável ao tipo de despesa | Div. de Finanças |
| e4 | atividade | Seguir a tramitação local até empenho/pagamento | Div. de Finanças |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DFIN/DFIN-03.pop.json` (diretrizes v1.0)._
