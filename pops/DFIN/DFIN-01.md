...
| Fontes (entradas do Canvas) | 1780963200040 |
...
| 2 | Seguir a tramitação local de diárias nacionais | A definir | — | — | A definir | — |
| 3 | Conferir com o procedimento textual de Diárias Nacionais (PRAF) | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Finanças"]
    ...
    e3["Seguir a tramitação local de diárias nacionais"]
    e4["Conferir com o procedimento textual de Diárias Nacionais (PRAF)"]
    e5((("Concluído")))
  end
  e1 --> e2
  e2 --> e3
...
| e3 | atividade | Seguir a tramitação local de diárias nacionais | Div. de Finanças |
| e4 | atividade | Conferir com o procedimento textual de Diárias Nacionais (PRAF) | Div. de Finanças |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DFIN/DFIN-01.pop.json` (diretrizes v1.0)._
