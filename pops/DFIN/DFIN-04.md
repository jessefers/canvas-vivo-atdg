...
| Normativa | Procedimentos de diárias — PRAF/Unioeste; Formulário e instrução de assinaturas — Diárias Nacionais (documento-fonte: Diárias_Nacionais.pdf) |
| Produto ATDG | POP |
| Pasta OneDrive | 03_MAPEAMENTO DE PROCESSOS |
| Fontes (entradas do Canvas) | 1780963200049 |
| Lacunas abertas | versao_documento, dados_pessoais_lgpd |
| Agente responsável | pop-dfin-04 |
...
- Solicitação de diárias nacionais com dados da viagem

### 3.3 Passo a passo

| Nº | Ação | Responsável | Sistema | Artefato | Prazo | Evento |
|---|---|---|---|---|---|---|
| 1 | Preencher o formulário de diárias nacionais (link oficial PRAF) | Servidor/Requisitante | e-Protocolo | Formulário de Diárias Nacionais | Até a data-limite definida pela PRAF | Formulário preenchido |
| 2 | Assinar e solicitar as demais assinaturas via e-Protocolo | Chefia imediata | e-Protocolo | Formulário assinado | A definir | Formulário assinado |
...
| 4 | Encaminhar (C27) à Secretária Financeira para conferência e indicação de fonte | Secretaria Financeira | e-Protocolo | Processo de diárias nacionais | A definir | Processo conferido |
| 5 | Conferir a regularidade do Cadin do interessado | Secretaria Financeira | Cadin | Consulta Cadin | A definir | Cadin conferido |
| 6 | Verificar a disponibilidade orçamentária e financeira | Secretaria Financeira | e-Protocolo | Declaração de Disponibilidade Orçamentária e Financeira (DDF) | A definir | Disponibilidade confirmada |
...
| 8 | Encaminhar à Div. de Contabilidade para empenho | Secretaria Financeira | e-Protocolo | Processo de diárias nacionais | A definir | Processo encaminhado à Contabilidade |
...
- Processo de diárias nacionais encaminhado à Contabilidade com fonte/conta indicada e empenhado
...
|---|---|---|---|
| Cadin regular? | A consulta ao Cadin do interessado retorna situação regular | Prosseguir com a verificação de disponibilidade orçamentária e financeira | Notificar/devolver ao requisitante até a regularização |
| Disponibilidade orçamentária e financeira confirmada? | Há saldo na fonte/conta indicada para a diária | Secretaria Financeira indica fonte/conta e encaminha à Div. de Contabilidade | Devolver ao requisitante ou acionar remanejamento orçamentário |
...
- Usar sempre os links oficiais de formulário e de instrução de assinatura vigentes da PRAF.
...
flowchart LR
  subgraph R1["Servidor/Requisitante"]
    ...
    e2["Preencher o formulário de diárias nacionais (link PRAF)"]
    e4["Anexar folder/justificativa da viagem"]
    e5["Consultar o Cadin do interessado e anexar comprovante"]
  end
  subgraph R2["Chefia imediata"]
    direction LR
    e3["Assinar e solicitar assinaturas via e-Protocolo"]
  end
  subgraph R3["Secretaria Financeira"]
    direction LR
    e6[["✉ Encaminhar (C27) à Secretária Financeira para conferência e fonte"]]
    e7{"Cadin regular?"}
    e8["Notificar/devolver ao requisitante para regularização"]
    e9((("Processo suspenso até regularização do Cadin")))
    e10{"Disponibilidade orçamentária e financeira confirmada?"}
  ...
  subgraph R4["Div. de Contabilidade"]
    direction LR
    e14[["✉ Encaminhar à Div. de Contabilidade para empenho"]]
    e15["Emitir nota de empenho"]
    e16((("Diária nacional empenhada")))
  end
  e1 --> e2
  e2 --> e3
  e3 --> e4
  ...
  class e6,e14 captura
  class e7,e10 decisao
  class e9,e12,e16 fim
```

## 11. Especificação BPMN para o Miro

**Raias:** Servidor/Requisitante · Chefia imediata · Secretaria Financeira · Div. de Contabilidade

| Id | Tipo | Elemento | Raia |
|---|---|---|---|
| e1 | inicio | Necessidade de viagem a serviço no território nacional | Servidor/Requisitante |
| e2 | atividade | Preencher o formulário de diárias nacionais (link PRAF) | Servidor/Requisitante |
| e3 | atividade | Assinar e solicitar assinaturas via e-Protocolo | Chefia imediata |
| e4 | atividade | Anexar folder/justificativa da viagem | Servidor/Requisitante |
| e5 | atividade | Consultar o Cadin do interessado e anexar comprovante | Servidor/Requisitante |
| e6 | captura | Encaminhar (C27) à Secretária Financeira para conferência e fonte | Secretaria Financeira |
...
| e10 | decisao | Disponibilidade orçamentária e financeira confirmada? | Secretaria Financeira |
...
| e14 | captura | Encaminhar à Div. de Contabilidade para empenho | Div. de Contabilidade |
| e15 | atividade | Emitir nota de empenho | Div. de Contabilidade |
| e16 | fim | Diária nacional empenhada | Div. de Contabilidade |
...
| 1.0.0 | 2026-09-03 | agente:construtor-pop (lote D1) | major | Passo 1 alterado (acao, responsavel, sistema, artefato, prazo, evento); Passo 2 alterado (acao, responsavel, sistema, artefato, prazo, evento); Passo 3 alterado (acao, responsavel, sistema, artefato, prazo, evento); Passo 4 alterado (acao, responsavel, sistema, artefato, prazo, evento); Passo 5 alterado (acao, responsavel, sistema, artefato, prazo, evento); Passo adicionado após 4: Conferir a regularidade do Cadin do interessado; Passo adicionado após 4: Verificar a disponibilidade orçamentária e financeira; Passo adicionado após 4: Indicar a fonte e a conta orçamentária da diária; Passo adicionado após 5: Emitir a nota de empenho da diária nacional; entrada_nova: +1; saida_nova: +1; artefatos_novos: +5; decisoes_novas: +2; kpis_novos: +2; mapa_contexto_novo: +3; pontos_atencao_novos: +4; contingencia_nova: +4; checklist_novo: +6; glossario_novo: +5; normativa_nova: +1; Campo identificacao.responsavel atualizado; Campo playbook.gatilho atualizado; Raias adicionadas: Servidor/Requisitante, Chefia imediata, Secretaria Financeira, Div. de Contabilidade; Elementos BPMN removidos: e1, e2, e3, e4, e5, e6, e7; Elementos BPMN adicionados: 16; Status promovido a em_validacao (≥ 3 passos e responsável definido) | 1780963200049 |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DFIN/DFIN-04.pop.json` (diretrizes v1.2)._
