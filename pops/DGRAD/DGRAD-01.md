...
| Normativa | Manual de Fluxos e-Protocolo — PROGRAD/Unioeste |
| Produto ATDG | POP |
...
| 2 | Abrir e instruir o e-Protocolo conforme o fluxo específico | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Graduação"]
    ...
    e3["Abrir e instruir o e-Protocolo conforme o fluxo específico"]
...
| e3 | atividade | Abrir e instruir o e-Protocolo conforme o fluxo específico | Div. de Graduação |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DGRAD/DGRAD-01.pop.json` (diretrizes v1.0)._
