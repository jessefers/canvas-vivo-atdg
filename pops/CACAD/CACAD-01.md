...
| Normativa | Manual de Fluxos e-Protocolo — PROEX/Unioeste |
| Produto ATDG | POP |
...
|---|---|---|---|---|---|---|
| 1 | Classificar a atividade de extensão (com/sem recursos; proponente) | A definir | — | — | A definir | — |
| 2 | Abrir o e-Protocolo conforme o fluxo da modalidade | A definir | — | — | A definir | — |
| 3 | Anexar documentação e encaminhar às instâncias previstas | A definir | — | — | A definir | — |
| 4 | Acompanhar aprovação na PROEX | A definir | — | — | A definir | — |
...
```mermaid
flowchart LR
  subgraph R1["Coordenação Acadêmica — Geral"]
    direction LR
    e1(("A definir"))
    e2["Classificar a atividade de extensão (com/sem recursos; proponente)"]
    e3["Abrir o e-Protocolo conforme o fluxo da modalidade"]
    e4["Anexar documentação e encaminhar às instâncias previstas"]
    e5["Acompanhar aprovação na PROEX"]
    e6((("Concluído")))
  end
  e1 --> e2
  e2 --> e3
...
**Raias:** Coordenação Acadêmica — Geral

| Id | Tipo | Elemento | Raia |
|---|---|---|---|
| e1 | inicio | A definir | Coordenação Acadêmica — Geral |
| e2 | atividade | Classificar a atividade de extensão (com/sem recursos; proponente) | Coordenação Acadêmica — Geral |
| e3 | atividade | Abrir o e-Protocolo conforme o fluxo da modalidade | Coordenação Acadêmica — Geral |
| e4 | atividade | Anexar documentação e encaminhar às instâncias previstas | Coordenação Acadêmica — Geral |
| e5 | atividade | Acompanhar aprovação na PROEX | Coordenação Acadêmica — Geral |
| e6 | fim | Concluído | Coordenação Acadêmica — Geral |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/CACAD/CACAD-01.pop.json` (diretrizes v1.0)._
