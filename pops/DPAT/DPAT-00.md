...
|---|---|---|
| Secretaria Administrativa | Div. de Patrimônio e Equipamentos | Divisão de Patrimônio e Equipamentos da Secretaria Administrativa. Playbook em construção (tombamento, controle e desfazimento de bens). |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Suprimentos e Materiais | Visão geral do setor (playbook) | core | S03.05-DPAT |
...
|---|---|
| Código | DPAT-00 |
| Setor | Div. de Patrimônio e Equipamentos (`S03.05-DPAT`) |
...
graph TD
  ...
  P["DPAT-00<br/>Visão geral — Div. de Patrimônio e Equipamentos"]
  S03_05_DPAT --> P
  classDef setor fill:#EEF0F7,stroke:#1B2747,stroke-width:1.5px,color:#1B2747
  classDef destaque fill:#FDEAEE,stroke:#CC1544,stroke-width:3px,color:#1B2747
  classDef vizinho fill:#E0F2F8,stroke:#0B4D66,stroke-width:1.5px,color:#0B4D66
  class S01_DG,S03_SADM,S03_05_DPAT setor
  class P destaque
```
...
**Raias:** Div. de Patrimônio e Equipamentos
