...
|---|---|---|---|
| Infraestrutura e Serviços | Controle Manual DSMC — Tempos de Limpeza | suporte | S03.01-DMC |
...
| 3 | Dimensionar equipe (qtd. de pessoal) | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Manutenção e Conservação"]
    ...
    e4["Dimensionar equipe (qtd. de pessoal)"]
...
| e4 | atividade | Dimensionar equipe (qtd. de pessoal) | Div. de Manutenção e Conservação |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DMC/DMC-01.pop.json` (diretrizes v1.0)._
