---
codigo: DATL-00
titulo: "Visão geral — Div. de Apoio Técnico aos Laboratórios"
versao: "0.2.0"
status: rascunho
...
# POP DATL-00 — Visão geral — Div. de Apoio Técnico aos Laboratórios
...
|---|---|---|
| Secretaria Administrativa | Div. de Apoio Técnico aos Laboratórios | Divisão de Apoio Técnico aos Laboratórios da Secretaria Administrativa. Playbook em construção. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Infraestrutura e Serviços | Visão geral do setor (playbook) | suporte | S03.08-DATL |
...
|---|---|
| Código | DATL-00 |
| Setor | Div. de Apoio Técnico aos Laboratórios (`S03.08-DATL`) |
...
graph TD
  ...
  P["DATL-00<br/>Visão geral — Div. de Apoio Técnico aos Laboratórios"]
  S03_08_DATL --> P
  classDef setor fill:#EEF0F7,stroke:#1B2747,stroke-width:1.5px,color:#1B2747
  classDef destaque fill:#FDEAEE,stroke:#CC1544,stroke-width:3px,color:#1B2747
  classDef vizinho fill:#E0F2F8,stroke:#0B4D66,stroke-width:1.5px,color:#0B4D66
  class S01_DG,S03_SADM,S03_08_DATL setor
  class P destaque
```
...
- Se o setor não tiver processos definidos, priorizar o mapeamento das atividades de maior volume ou risco (apoio técnico às aulas práticas e aos laboratórios)
...
```mermaid
flowchart LR
  subgraph R1["Div. de Apoio Técnico aos Laboratórios"]
    direction LR
    e1(("A definir"))
...
**Raias:** Div. de Apoio Técnico aos Laboratórios

| Id | Tipo | Elemento | Raia |
|---|---|---|---|
| e1 | inicio | A definir | Div. de Apoio Técnico aos Laboratórios |
| e2 | atividade | Levantar as atividades e rotinas da área junto à chefia e aos servidores | Div. de Apoio Técnico aos Laboratórios |
| e3 | atividade | Mapear os fluxos e os responsáveis por etapa | Div. de Apoio Técnico aos Laboratórios |
| e4 | atividade | Identificar as normas aplicáveis e os pontos de atenção | Div. de Apoio Técnico aos Laboratórios |
| e5 | fim | Concluído | Div. de Apoio Técnico aos Laboratórios |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DATL/DATL-00.pop.json` (diretrizes v1.8)._
