...
**Raias:** Div. de Assistência Estudantil
...
| e5 | fim | Concluído | Div. de Assistência Estudantil |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DAE/DAE-00.pop.json` (diretrizes v1.0)._
