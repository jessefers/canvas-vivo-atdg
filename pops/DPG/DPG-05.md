...
| Normativa | Resolução nº 078/2016-CEPE; Manual de Fluxos e-Protocolo PRPPG |
| Produto ATDG | POP |
...
|---|---|---|---|---|---|---|
| 1 | Identificar o ato (proposta, implantação, modificação, disciplina) | A definir | — | — | A definir | — |
| 2 | Abrir o e-Protocolo conforme o fluxo específico | A definir | — | — | A definir | — |
| 3 | Anexar projeto pedagógico/regulamento conforme exigido | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Pós-Graduação"]
    direction LR
    e1(("A definir"))
    e2["Identificar o ato (proposta, implantação, modificação, disciplina)"]
    e3["Abrir o e-Protocolo conforme o fluxo específico"]
    e4["Anexar projeto pedagógico/regulamento conforme exigido"]
...
| e2 | atividade | Identificar o ato (proposta, implantação, modificação, disciplina) | Div. de Pós-Graduação |
| e3 | atividade | Abrir o e-Protocolo conforme o fluxo específico | Div. de Pós-Graduação |
| e4 | atividade | Anexar projeto pedagógico/regulamento conforme exigido | Div. de Pós-Graduação |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DPG/DPG-05.pop.json` (diretrizes v1.0)._
