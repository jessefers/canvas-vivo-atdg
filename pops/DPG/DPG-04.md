...
| Normativa | Resolução nº 071/2021-CEPE; Manual de Fluxos e-Protocolo PRPPG |
| Produto ATDG | POP |
...
|---|---|---|---|---|---|---|
| 1 | Identificar a modalidade/ato (proposta, alteração, substituição) | A definir | — | — | A definir | — |
| 2 | Abrir o e-Protocolo conforme o fluxo específico | A definir | — | — | A definir | — |
| 3 | Anexar projeto, cronograma e planilha financeira | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Pós-Graduação"]
    direction LR
    e1(("A definir"))
    e2["Identificar a modalidade/ato (proposta, alteração, substituição)"]
    e3["Abrir o e-Protocolo conforme o fluxo específico"]
    e4["Anexar projeto, cronograma e planilha financeira"]
...
| e2 | atividade | Identificar a modalidade/ato (proposta, alteração, substituição) | Div. de Pós-Graduação |
| e3 | atividade | Abrir o e-Protocolo conforme o fluxo específico | Div. de Pós-Graduação |
| e4 | atividade | Anexar projeto, cronograma e planilha financeira | Div. de Pós-Graduação |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DPG/DPG-04.pop.json` (diretrizes v1.0)._
