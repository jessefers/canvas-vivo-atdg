...
| Normativa | Manual de Fluxos e-Protocolo — PRPPG/CEUAP |
| Produto ATDG | POP |
...
| 3 | Tramitar ao Presidente do CEUAP para autorização | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Pós-Graduação"]
    ...
    e4["Tramitar ao Presidente do CEUAP para autorização"]
...
| e4 | atividade | Tramitar ao Presidente do CEUAP para autorização | Div. de Pós-Graduação |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DPG/DPG-03.pop.json` (diretrizes v1.0)._
