...
| Normativa | Resolução nº 029/2013-CEPE; Manual de Fluxos e-Protocolo PRPPG |
| Produto ATDG | POP |
...
|---|---|---|---|---|---|---|
| 1 | Identificar a modalidade de afastamento/qualificação | A definir | — | — | A definir | — |
| 2 | Abrir o e-Protocolo conforme o fluxo aplicável | A definir | — | — | A definir | — |
| 3 | Anexar documentação exigida (plano, aceite, comprovantes) | A definir | — | — | A definir | — |
| 4 | Acompanhar deliberação na PRPPG e retorno | A definir | — | — | A definir | — |
...
flowchart LR
  subgraph R1["Div. de Pós-Graduação"]
    direction LR
    e1(("A definir"))
    e2["Identificar a modalidade de afastamento/qualificação"]
    e3["Abrir o e-Protocolo conforme o fluxo aplicável"]
    e4["Anexar documentação exigida (plano, aceite, comprovantes)"]
    e5["Acompanhar deliberação na PRPPG e retorno"]
    e6((("Concluído")))
  end
  e1 --> e2
  e2 --> e3
...
| e2 | atividade | Identificar a modalidade de afastamento/qualificação | Div. de Pós-Graduação |
| e3 | atividade | Abrir o e-Protocolo conforme o fluxo aplicável | Div. de Pós-Graduação |
| e4 | atividade | Anexar documentação exigida (plano, aceite, comprovantes) | Div. de Pós-Graduação |
| e5 | atividade | Acompanhar deliberação na PRPPG e retorno | Div. de Pós-Graduação |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DPG/DPG-01.pop.json` (diretrizes v1.0)._
