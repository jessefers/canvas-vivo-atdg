...
|---|---|---|
| Secretaria Administrativa | Div. de Almoxarifado | Relatórios e Prestação de Contas — Relatórios gerenciais e de prestação de contas. Processo codificado no manual institucional da ATDG (jun/2026); conteúdo operacional a documentar. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Suprimentos e Materiais | Relatórios e Prestação de Contas | core | S03.04-ALM |
