...
|---|---|---|
| Secretaria Administrativa | Div. de Almoxarifado | Distribuição para Departamentos — Saída, requisição, entrega, registro. Processo codificado no manual institucional da ATDG (jun/2026); conteúdo operacional a documentar. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Suprimentos e Materiais | Distribuição para Departamentos | core | S03.04-ALM |
