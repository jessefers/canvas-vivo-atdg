...
|---|---|---|
| Direção de Centro (competências gerais) | Direção de Centro (competências gerais) | Guia das competências da Direção de Centro e das assessorias (de área, de ensino e de extensão), conforme o art. 37 do Estatuto. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Ensino, Pesquisa e Extensão (Centro) | Visão geral do setor (playbook) | core | S13-DCEN |
...
| Fontes (entradas do Canvas) | pb-direcao-centro |
...
|---|---|---|---|---|---|---|
| 1 | Representar o Centro em eventos e reuniões internas/externas | A definir | — | — | A definir | — |
| 2 | Nomear representantes para comitês, conselhos e GTs | A definir | — | — | A definir | — |
| 3 | Convocar e presidir o Conselho de Centro | A definir | — | — | A definir | — |
| 4 | Articular ensino com a PROGRAD e extensão com a PROEX | A definir | — | — | A definir | — |
...
```mermaid
flowchart LR
  subgraph R1["Direção de Centro"]
    direction LR
    e1(("A definir"))
    e2["Representar o Centro em eventos e reuniões internas/externas"]
    e3["Nomear representantes para comitês, conselhos e GTs"]
    e4["Convocar e presidir o Conselho de Centro"]
    e5["Articular ensino com a PROGRAD e extensão com a PROEX"]
    e6((("Concluído")))
  end
  e1 --> e2
  e2 --> e3
...
**Raias:** Direção de Centro

| Id | Tipo | Elemento | Raia |
|---|---|---|---|
| e1 | inicio | A definir | Direção de Centro |
| e2 | atividade | Representar o Centro em eventos e reuniões internas/externas | Direção de Centro |
| e3 | atividade | Nomear representantes para comitês, conselhos e GTs | Direção de Centro |
| e4 | atividade | Convocar e presidir o Conselho de Centro | Direção de Centro |
| e5 | atividade | Articular ensino com a PROGRAD e extensão com a PROEX | Direção de Centro |
| e6 | fim | Concluído | Direção de Centro |
