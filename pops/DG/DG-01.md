...
| e2 | fim | Concluído | Direção Geral de Campus |
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DG/DG-01.pop.json` (diretrizes v1.0)._
