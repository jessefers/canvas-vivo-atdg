...
|---|---|---|
| Biblioteca | Biblioteca | Área da Biblioteca do Campus (circulação, referência, preservação e conservação do acervo). Playbook em construção. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Informação e Acervo | Visão geral do setor (playbook) | suporte | S06-BIB |
...
|---|---|---|---|
| e1 | inicio | A definir | Biblioteca |
| e2 | atividade | A documentar: levantar atividades e rotinas da área | Biblioteca |
| e3 | atividade | Mapear fluxos e responsáveis por etapa | Biblioteca |
| e4 | atividade | Identificar normas aplicáveis e pontos de atenção | Biblioteca |
| e5 | fim | Concluído | Biblioteca |
