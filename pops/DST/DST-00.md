...
|---|---|---|
| Secretaria Administrativa | Div. de Segurança e Transportes | Divisão de Segurança e Transportes da Secretaria Administrativa. Playbook em construção. |

| Domínio | Subdomínio | Tipo | Contexto delimitado |
|---|---|---|---|
| Infraestrutura e Serviços | Visão geral do setor (playbook) | suporte | S03.02-DST |
...
|---|---|
| Código | DST-00 |
| Setor | Div. de Segurança e Transportes (`S03.02-DST`) |
...
graph TD
  ...
  S03_SADM --> S03_02_DST
  P["DST-00<br/>Visão geral — Div. de Segurança e Transportes"]
  S03_02_DST --> P
  classDef setor fill:#EEF0F7,stroke:#1B2747,stroke-width:1.5px,color:#1B2747
  classDef destaque fill:#FDEAEE,stroke:#CC1544,stroke-width:3px,color:#1B2747
  classDef vizinho fill:#E0F2F8,stroke:#0B4D66,stroke-width:1.5px,color:#0B4D66
  class S01_DG,S03_SADM,S03_02_DST setor
  class P destaque
```
...
- Se o setor não tiver processos definidos, priorizar o mapeamento das atividades de maior volume ou risco (segurança patrimonial e transporte de servidores)
...
**Raias:** Div. de Segurança e Transportes
...
---
_Canvas Vivo — Base de Conhecimento Institucional · ATDG · UNIOESTE Campus Foz do Iguaçu · gerado por `scripts/render_pop.py` a partir de `pops/DST/DST-00.pop.json` (diretrizes v1.8)._
