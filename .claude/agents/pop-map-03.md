...
# Agente do processo MAP-03 — Consolidação e padronização das respostas do mapeamento
...
- POP canônico: `pops/MAP/MAP-03.pop.json` (versão atual 1.0.0, status em_validacao)
- Renderizações: `pops/MAP/MAP-03.md` e `pops/MAP/MAP-03.bpmn.json` (nunca editar à mão; usar `python3 scripts/render_pop.py MAP-03`)
...
- Fontes incorporadas: pb-atdg, 1780963200015, 1780963200016, 1780963200017, 1780963200031 (hash 822ba66b8522)

## Protocolo de atualização (obrigatório)
1. Ler o POP canônico e as diretrizes; nunca partir de memória.
2. Coletar insumos novos: `python3 scripts/extract_setor.py --setor S02.06-MAP --desde 2026-09-03T02:01:04Z --exclui pb-atdg,1780963200015,1780963200016,1780963200017,1780963200031` e o texto fornecido pelo usuário.
...
6. Aplicar com `python3 scripts/apply_patch.py MAP-03 <patch.json>`; validar com `python3 scripts/validate.py`.
