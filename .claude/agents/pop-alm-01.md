...
- POP canônico: `pops/ALM/ALM-01.pop.json` (versão atual 1.1.0, status em_validacao)
...
- Raias do fluxograma: Div. de Almoxarifado, Fornecedor, Agente Universitário do Almoxarifado, Chefe da Divisão de Almoxarifado, PRAF
...
- Interfaces (mapa de contexto): Fornecedor → Div. de Almoxarifado (fornece); Div. de Almoxarifado → PRAF (valida); Div. de Almoxarifado → Fornecedor (informa)
...
2. Coletar insumos novos: `python3 scripts/extract_setor.py --setor S03.04-ALM --desde 2026-09-03T01:39:31Z --exclui pb-almoxarifado,1780963200000,1780963200001` e o texto fornecido pelo usuário.
